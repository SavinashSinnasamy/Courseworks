...
public class Main {
    public static void main(String[] args) { //main method
        ...
        ArrayList<Customer> waitingQueue = new ArrayList<>(); //replaced new ArrayList<Customer>();
        ArrayList<Customer> customerNames = new ArrayList<>(); // initializing the arrays which hold the cashier data
            ...
            String option = input.next().toUpperCase();
                switch (option) {
                    ...
                    case "VEQ":
                        ...
                        for (Customer elements : waitingQueue) {
                            System.out.print(elements.toString());
                        }
                        out.println("Customer queue");
                        for (Customer elements : customerNames) {
                            System.out.print(elements.toString());
                        }
                        break;
                    ...
                    case "ACQ":
                        ...
                        while (addLoop) {
                            ...
                            if (stock == 0) { // checks whether the stock is 0 //checks the stock availability
                                ...
                                if (!(cashier3[4] == null)) {//checks the slot availability in the queues
                                    stock = FoodQueue.addToWaiting(waitingQueue,customerNames,stock,count);
                                } else {
                                    if (cashier1[0] == null) {// the stock gets updated when adding a customer by assigning the method to it.
                                        stock = FoodQueue.addCustomer(cashier1, customerNames, stock, 0);
                                    } else if (cashier1[1] == null) {
                                        stock = FoodQueue.addCustomer(cashier1, customerNames, stock, 1);
                                    } else if (cashier2[0] == null) {
                                        stock = FoodQueue.addCustomer(cashier2, customerNames, stock, 0);
                                    } else if (cashier2[1] == null) {
                                        stock = FoodQueue.addCustomer(cashier2, customerNames, stock, 1);
                                    } else if (cashier2[2] == null) {
                                        stock = FoodQueue.addCustomer(cashier2, customerNames, stock, 2);
                                    } else if (cashier3[0] == null) {
                                        stock = FoodQueue.addCustomer(cashier3, customerNames, stock, 0);
                                    } else if (cashier3[1] == null) {
                                        stock = FoodQueue.addCustomer(cashier3, customerNames, stock, 1);
                                    } else if (cashier3[2] == null) {
                                        stock = FoodQueue.addCustomer(cashier3, customerNames, stock, 2);
                                    } else if (cashier3[3] == null) {
                                        stock = FoodQueue.addCustomer(cashier3, customerNames, stock, 3);
                                    } else {
                                        stock = FoodQueue.addCustomer(cashier3, customerNames, stock, 4);
                                    }
                            ...
                            switch (removeQueue) {
                                case "1":
                                    ...
                                    if (customerLocation1.equals("1") || customerLocation1.equals("2")) {
                                        stock = FoodQueue.removeCustomer(cashier1, customerNames, waitingQueue, stock, customerLocation1);//calling removeCustomer function by passing parameters
                                    } else {
                                ...
                                case "2":
                                    ...
                                    if (customerLocation2.equals("1") || customerLocation2.equals("2") || customerLocation2.equals("3")) {
                                        stock = FoodQueue.removeCustomer(cashier2, customerNames, waitingQueue, stock, customerLocation2);//calling removeCustomer function by passing parameters
                                    } else {
                                        out.print("Invalid input !!\nEnter desired number\n");
                                    }
                                    break;
                                case "3":
                                    ...
                                    if (customerLocation3.equals("1") || customerLocation3.equals("2") || customerLocation3.equals("3") || customerLocation3.equals("4") || customerLocation3.equals("5")) {
                                        stock = FoodQueue.removeCustomer(cashier3, customerNames, waitingQueue, stock, customerLocation3);//calling removeCustomer function by passing parameters
                                    } else {
                                        out.print("Invalid input !!\nEnter desired number\n");
                                    }
                                    break;
                        ...
                        while (removeServedLoop) {//served customer removing function loop
                            ...
                            switch (removeServedQueue) {
                                case "1":
                                    ...
                                    if (customerLocation1.equals("1") || customerLocation1.equals("2")) {
                                        FoodQueue.removeServedCustomer(cashier1, customerNames, waitingQueue, customerLocation1);
                                    } else {
                                        out.print("Invalid input !!\nEnter desired number\n");
                                    }
                                    break;
                                case "2":
                                    ...
                                    if (customerLocation2.equals("1") || customerLocation2.equals("2") || customerLocation2.equals("3")) {
                                        FoodQueue.removeServedCustomer(cashier2, customerNames, waitingQueue, customerLocation2);
                                    } else {
                                        out.print("Invalid input !!\nEnter desired number\n");
                                    }
                                    break;
                                case "3":
                                    ...
                                    if (customerLocation3.equals("1") || customerLocation3.equals("2") || customerLocation3.equals("3") || customerLocation3.equals("4") || customerLocation3.equals("5")) {
                                        FoodQueue.removeServedCustomer(cashier3, customerNames, waitingQueue, customerLocation3);
                                    } else {
                                        out.print("Invalid input !!\nEnter desired number\n");
                                    }
                                    break;
                    ...
                    case "106":
                    case "SPD":
                        FoodQueue.storeData(cashier1,cashier2,cashier3,waitingQueue,customerNames,stock);
                        break;

                    case "107":
                    case "LPD":
                        stock = FoodQueue.loadingData(cashier1,cashier2,cashier3,waitingQueue,customerNames,stock);
                        break;
                    ...
                    case "112":
                    case "GUI":
                        out.print("The GUI of Food Queue");
                        break;
                    case "999":
                    case "EXT":
