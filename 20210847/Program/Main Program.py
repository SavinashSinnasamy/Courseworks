...
while choiceMain:
    ...
    if q1 == "Y" or q1 == "y":
        ...
        if q2 == "Y" or q2 == "y":
            ...
            #..Get user inputs for subjects table
                ...
                if q2b == "Y" or q2b == "y":
                    ...
                    if q2c == "Y" or q2c == "y":                        
                        ...
                        ansMain = input("Do you want to run the program again ? (Y/N) :")
                        if ansAE == "Y" or ansMain == "y":
                            choiceMain = True
                            print ()
                            continue
                        elif ansMain == "N" or ansMain == "n":
                            choiceMain = False
                            print ()
                            printStatements.main (run)
                            break
                        elif ansMain != "Y" or ansMain != "y" or ansMain != "N" or ansMain != "n":
                            choiceMain = False
                            print ()
                            printStatements.wronginput(output)
                        else:
                    ...
                    elif q2c != "Y" or q2c != "y" or q2c != "N" or q2c != "n" or q2b != "Y" or q2b != "y" or q2b != "N" or q2b != "n":
                        print()
                        printStatements.wronginput(output)
                        print()
                    else:
                ...
                elif q2b != "Y" or q2b != "y" or q2b != "N" or q2b != "n":
                    print()
                    printStatements.wronginput(output)
                    print()
                else:
            ...
            elif q2a != "Y" or q2a != "y" or q2a != "N" or q2a != "n":
                print()
                printStatements.wronginput(output)
                print()
            else:
            ...
            if q3 == "Y" or q3 == "y":
                ...
                if q3a == "Y" or q3a == "y":
                    ...
                    #..Get user inputs to update subject code
                        ...
                        printStatements.update1(subject2)
                    ...
                    #..Updating books table
                        ...
                        if q3c == "Y" or q3c == "y":
                            ...
                            if chapterdetails == "chapter number" or chapterdetails == "Chapter Number" or chapterdetails == "Chapter number" or chapterdetails == "CHAPTER NUMBER":
                                ...
                                printStatements.update3(chapter2)
                ...
                if q4 == "Y" or q4 == "y":
                    ...
                    if q4a == "Y" or q4a == "y":
                            ...
                            printStatements.delete1(subject3)
